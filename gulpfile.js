...
gulp.task('watch', function () {
    ...
    gulp.watch('bower_components/**/*.*', {cwd:'./'}, ['bower']);
...
gulp.task('server', function () {
    browserSync({
        ...
        browser: "chrome",
        files: [PRODUCTION + "/css/*.css", PRODUCTION + "/*.html", PRODUCTION + "/js/**/*.js"]
    });
});
...
gulp.task('init', gulpSequence('sprites-sass', ['bower', 'es6'], ['copy-fonts', 'copy-imgs', 'copy-assets'], 'pug', 'server'));
